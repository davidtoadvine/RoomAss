...
class Room(models.Model):
  ...
  def is_available(self, start_date, end_date):
        ...
        # Setting end date to day prior, hacky fix for edge cases that were not comparing correctly.
        # Otherwise an occupancy ending on a given morning would make room unavailable for later that afternoon.
        ...
        if occupancy_events:
            print("occupancy event!!!")
        for i in occupancy_events:
            print("HEREHEHRHERHEHREH")
            print(i)
  ...
  def get_last_available_date(self, start_date):
        ...
        print(f"next_occupancy: {next_occupancy}")
