...
from catalog.views.ownership_views import remove_owner, assign_owner



urlpatterns = [
    
    path('', available_rooms, name='available_rooms'),  # Home page
